  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
    <g clip-path="url(#clip0_15_249)">
      <path
          ...
          stroke="#9B51E0" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M5.5 8.5L8 11L10.5 8.5" stroke="#9B51E0" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M8 11V1.5" stroke="#9B51E0" stroke-linecap="round" stroke-linejoin="round"/>
    </g>
    <defs>
